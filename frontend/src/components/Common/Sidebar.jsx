...
const menuItemsConfig = [
    ...
    },
    {
      ...
      submenu: [
        { label: 'CT-e', path: '/ctes', modulo: 'cte' },
        { label: 'MDF-e', path: '/mdfes', modulo: 'mdfe' },
        { label: 'Upload XML', path: '/upload', modulo: 'cte' }
      ]
    },
    {
      id: 'cadastros',
      ...
      submenu: [
        ...
        { label: 'Motoristas', path: '/motoristas', modulo: 'motoristas' },
        { label: 'Veículos', path: '/veiculos', modulo: 'veiculos' }
      ]
    },
    {
      id: 'financeiro',
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: 'Planos de Manutenção', path: '/planos-manutencao', modulo: 'veiculos' },
        { label: 'Pedágios', path: '/pedagios', modulo: 'frota' },
        { label: 'Multas/Sinistros', path: '/frota/multas-sinistros', modulo: 'frota' },
        { label: 'Tabela de Frete', path: '/tabelas-frete', modulo: 'frota' },
        { label: 'Manutenção', path: '/manutencoes', modulo: 'veiculos' }
      ]
    },
    {
      id: 'manutencao',
  ...
  // Filtra itens de menu com base nas permissões do usuário
