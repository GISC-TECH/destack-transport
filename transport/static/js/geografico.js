...
function setDefaultDateRangeGeo() {
    ...
    // Usar o mês atual como padrão (primeiro dia até último dia)
    ...
    console.log(`Datas padrão definidas: ${formatDateForInput(firstDayOfMonth)} a ${formatDateForInput(lastDayOfMonth)}`);
}
